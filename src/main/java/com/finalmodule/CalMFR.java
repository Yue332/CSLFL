 ...
 * Date: 2022/9/20
 **/
public class CalMFR extends FinalBean implements IFinalProcessModule {
    ...
    public void process(Runtime runTime, StringBuilder processLog) throws Exception {
        ...
        readBugIdList.forEach(bugid ->{
            ...
            try {
                List<BuggyMethod> buggyMethodList = Csv2BeanUtil.convertCsv2Bean(buggyMethodFile, BuggyMethod.class);
        ...
        File outputFile = new File("/home/yy/MFR/" + projectId + "-" + funcName + "-MFR.csv");
        mfr.output(outputFile);
    }
    ...
    private class MFR {
        ...
        private static final String HEAD = "projectid,bugid,MFR\r\n";
