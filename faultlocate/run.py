...
NlLen_map = {"Time":3900, "Math":4500, "Lang":280, "Chart": 2350}
CodeLen_map = {"Time":1300, "Math":2700, "Lang":300, "Chart":5250}
args = dotdict({
...
def load_model(model, dirs="checkpointcodeSearch"):
    assert os.path.exists(dirs + '/best_model.ckpt'),
